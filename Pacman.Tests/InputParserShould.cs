    ...
    public class InputParserShould
    {
        ...
        public void ReturnAGrid_GivenStringInput()
        {
            var cells = new List<Cell>()
            {
                ...
                new Cell(CellContent.None, CellState.Dot, 3, 1),
                ...
                new Cell(CellContent.None, CellState.Dot, 3, 2),
                new Cell(CellContent.None, CellState.Wall, 4, 2),
                new Cell(CellContent.None, CellState.Wall, 0, 3),
                new Cell(CellContent.None, CellState.Empty, 1, 3),
                new Cell(CellContent.None, CellState.Empty, 2, 3),
            ...
            var isEqual = PacmanHelper.GridsAreEqual(expected, result);
            Assert.True(isEqual);
        }
    }
}